...
interface DynamicNode {
	...
	isNode: true; // For faster access
	isAttr: false; // For faster access
	isTag: false; // For faster access
...
interface DynamicAttribute {
	...
	isNode: false; // For faster access
	isAttr: true; // For faster access
	isTag: false; // For faster access
}
 ...
 */
export const useState: <State>(defaultValue: State) => StateHook<State>;
 ...
 */
export const useRef: <T>(initialValue: T | null) => RefHook<T>;
 ...
 */
export const useCallback: (callbackFn: CallbackHook) => CallbackHook;
 ...
 */
export const useMemo: (callbackFn: () => any, dependencies: any[]) => MemoHook;
 ...
 */
export const useExposed: <E = {}>(toExpose: E) => void;
 ...
 * ```
 */
export const createContext: <S>(initialValue: S) => Context<S>;
 ...
 */
export const useContext: (Context: Context) => ContextHook;
 ...
 */
export const html: (templateParts: TemplateStringsArray, ...values: any[]) => RenderHtml;
 ...
 */
export const defineWomp: <Props extends WompProps, E = {}>(
	component: WompComponent,
	options?: WompComponentOptions
) => WompElementClass<Props, E>;

export const jsx: (Element: any, attributes: { [key: string]: any }) => RenderHtml;
