 ...
 */
export type WompoElement<Props extends WompoProps = WompoProps, E = {}> = HTMLElement & E & {
    /**
...
export type Hook = StateHook<any> | EffectHook | RefHook<any> | CallbackHook | IdHook | MemoHook<any> | ReducerHook<any> | AsyncHook<any> | ContextHook;
 ...
 */
export declare const useCallback: (callbackFn: (...args: any[]) => any, dependencies?: any[]) => (...args: any[]) => any;
/**
