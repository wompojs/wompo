 ...
 */
export declare type WompElement<Props extends WompProps = WompProps, E = {}> = HTMLElement & E & {
    /**
...
declare type Hook = StateHook<any> | EffectHook | RefHook<any> | CallbackHook | IdHook | MemoHook | ReducerHook<any> | ContextHook<any>;
/** The hook generated by the useState function */
declare type StateHook<S> = [S, (newValue: S) => void];
...
/** The hook generated by the useState function */
declare type ReducerHook<State> = [State, (state: any, action: ReducerAction) => void];
...
declare type ContextInstance = WompElement<ContextProviderProps, ContextProviderExposed>;
 ...
 */
declare type Dynamics = DynamicNode | DynamicAttribute | DynamicTag;
/**
